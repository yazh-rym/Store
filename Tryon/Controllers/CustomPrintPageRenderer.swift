...
class CustomPrintPageRenderer: UIPrintPageRenderer {
    ...
    override func drawHeaderForPage(at pageIndex: Int, in headerRect: CGRect) {
        ...
        let headerText: NSString = "Order Form"
        
        // Set the desired font.
        let font = UIFont(name: "SFUIText-Bold", size: 30.0)
        
        // Specify some text attributes we want to apply to the header text.
        let textAttributes = [NSFontAttributeName: font!, NSForegroundColorAttributeName: UIColor(red: 65.0/255, green: 16.0/255.0, blue: 141.0/255.0, alpha: 1.0), NSKernAttributeName: 7.5] as [String : Any]
        ...
        let offsetX: CGFloat = headerRect.size.width/2 //20.0
        
        // Specify the point that the text drawing should start from.
        let pointX = headerRect.size.width/2 - textSize.width/2// - offsetX
        let pointY = headerRect.size.height/2 - textSize.height/4//2
    ...
    override func drawFooterForPage(at pageIndex: Int, in footerRect: CGRect) {
        ...
        let font = UIFont(name: "Noteworthy-Bold", size: 12.0)
